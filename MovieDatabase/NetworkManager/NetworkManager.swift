...
class NetworkManager {
    ...
    static func fetchSimilarMovies(movieId: String, completion: @escaping (Movies) -> () ) {
        
        guard let url = URL(string: "https://api.themoviedb.org/3/movie/\(movieId)/similar?api_key=\(Constants.API.apiKey)") else { return }
